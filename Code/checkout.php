...
if(isset($_SESSION['total'])==0){
    echo "<script> alert('Anda Belum Memilih Pesanan'); window.history.go(-1); </script>";
  }
...
​                   ​​john@example.com" required>
        ...
        <input type="submit" value="Konfirmasi Pemesanan" class="btn">
      </form>
    </div>
  </div>
  <div class="col-25">
    <div class="container">
      ...
      <hr>
      <p>Jumlah Harga <span class="price" style="color:black"><b><?php echo "Rp. ". number_format($total, 2, ".", ",");?></span></p>
    </div>
  </div>
</div>
</body>
