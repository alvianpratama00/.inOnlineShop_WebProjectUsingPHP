...
if(in_array($ext, $ext_boleh)){
 ...
 $tujuan = 'kategori_image/kids/at/' . $foto['name'];
...
echo "<script>alert('File berhasil dimasukkan');window.location='form_kids_at.php'</script>";
}else{
 echo "<script>alert('File tidak valid');window.location='form_kids_at.php'</script>";
}
