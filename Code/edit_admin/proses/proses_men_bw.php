...
if(in_array($ext, $ext_boleh)){
 ...
 $tujuan = 'kategori_image/men/bw/' . $foto['name'];
...
echo "<script>alert('File berhasil dimasukkan');window.location='form_men_bw.php'</script>";
}else{
 echo "<script>alert('File tidak valid');window.location='form_men_bw.php'</script>";
}
