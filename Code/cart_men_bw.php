    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="cart_men_bw.php"</script>';
            }else{
...
<body style="display: flex;">
    ...
    <div class="container" style="width: 65%">
        <h2>Shopping Cart</h2>
        <?php
            $query = "SELECT * FROM img_men where kategori = 'bw'";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="cart_men_bw.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="cart_men_bw.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
